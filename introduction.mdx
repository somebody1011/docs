...
description: "FinConnect is a TypeScript SDK that unifies East Africa fintech companies' mobile payment services behind a single API, eliminating per-provider auth flows and payload differences for Node.js apps."
