---
title: "azampay-provider"
description: "Reference for AzampayProvider: JWT token generation via authenticate() and USSD push payment initiation via initiateUssdPushRequest() for  Azampay."
sidebarTitle: "azampayProvider"
---
...
```typescript https://githubusercontent.com + somebody1011/finconnect/main/src/provider/AzampayProvider.ts
